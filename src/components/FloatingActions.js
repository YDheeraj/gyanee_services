        ...
        <div className="fixed bottom-4 right-4 z-50 flex flex-col space-y-3 lg:hidden">
            ...
            >
                <svg
                    ...
                    viewBox="0 0 24 24"
                >
                    <path d="M6.62 10.79a15.05 15.05 0 006.59 6.59l2.2-2.2a1 1 0 011.11-.21 11.36 11.36 0 003.55.57 1 1 0 011 1V20a1 1 0 01-1 1A16 16 0 013 5a1 1 0 011-1h3.5a1 1 0 011 1 11.36 11.36 0 00.57 3.55 1 1 0 01-.21 1.11l-2.24 2.13z" />
                </svg>
            </a>
        </div>
    );
